...
- **Biblia_de_la_Historia.md** — the story roadmap: premise, theme, protagonist (Kael Doran, full character sheet + timeline + his inherited Artífice revolvers), macro 3-act structure, his saga-wide power progression (final ceiling: Vorágine; dual Senda Rastreador/Profeta del Rastro unlocked at Sima), and the Act 1 secondary cast (mentor Soraya Vahn, cohort, who orders the silence). The manuscript itself doesn't exist yet — this is the blueprint before prose.
- **Mapa_Volumen_1.md** — the chapter-level map of Volume I only: internal arcs per act, antagonists and their escalation, subplots and where they evolve, and the ~328-chapter budget. Expands `Biblia_de_la_Historia.md` section 4 — keep both in sync if Kael's progression or cast changes.
